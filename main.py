...
import sys
import pandas as pd
from index.reporting import export_index_performance_to_excel, export_index_composition_to_excel, export_index_summary_to_excel, export_index_composition_change
...
if __name__ == "__main__":
    ...
    for dt in pd.date_range(start_date, end_date):
        ...
        print("Exporting index composition change to excel..")
        export_index_composition_change(db_path)
